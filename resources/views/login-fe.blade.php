...
<body class="bg-gray-100 flex flex-col min-h-screen font-roboto">
    ...
    <!-- Main Content -->
    <main
        class="container mx-auto mt-20 flex flex-col lg:flex-row justify-evenly items-center lg:items-start lg:justify-self-center flex-grow">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <input id="username"
                        ...
                        placeholder="Email / Username" name="loginParam"
                        value="{{isset($email)?$email:old('loginParam')}}" required autofocus />
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input id="password" 
                        ...
                        value="{{isset($pass)?$password:''}}" />
                </div>

                <!-- Remember Me and Forgot Password -->
                <div class="flex justify-between items-center mb-4">
                    <label class="flex items-center text-gray-700 text-sm lg:text-base">
                        <input class="mr-2" type="checkbox" name="remember"/> Ingat Saya
                    </label>
                    <a class="text-xs lg:text-sm text-red-600 hover:underline"
                        href="{{ route('forgot-password-fe') }}">Lupa Password?</a>
                </div>
                ...
                <a href="/auth/google/redirect">
                    <button
                        ...
                        type="button">
                        <img src="{{ asset('assets/GoogleLogo.png') }}" alt="Google placeholder" class="mr-2"> Sign In
                        with Google
                    </button>
                </a>
