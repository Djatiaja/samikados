    ...
    <main class="container mx-auto mt-8 flex-row lg:flex justify-evenly items-center flex-grow">
        ...
        <section class="w-full lg:w-1/3 bg-white p-8 shadow-xl rounded-lg">
            ...
            <form>
                ...
                <!-- Submit Button -->
                <button class="w-full bg-red-600 hover:bg-red-700 text-white py-3 rounded-lg mb-4 transition duration-300 shadow-lg" type="button" onclick="window.location.href='{{ route('verification-otp-fe') }}'">
                    Berikutnya
                </button>
