  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
    <div class="bg-white p-4 sm:p-6 lg:p-8 rounded-lg shadow-md flex items-center space-x-4">
      ...
      <div>
        ...
        <p class="text-red-600 text-xl sm:text-2xl lg:text-3xl">{{$jumlah_produk}}</p>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
      ...
      <div>
        ...
        <p class="text-red-600 text-xl sm:text-2xl lg:text-3xl">{{$jumlah_kategori}}</p>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
      ...
      <div>
        ...
        <p class="text-red-600 text-xl sm:text-2xl lg:text-3xl">{{$jumlah_seller}}</p>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
      ...
      <div>
        ...
        <p class="text-red-600 text-xl sm:text-2xl lg:text-3xl">{{$pesanan_terbaru}}</p>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
      ...
      <div>
        ...
        <p class="text-red-600 text-xl sm:text-2xl lg:text-3xl">{{$pesanan_selesai}}</p>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
      ...
      <div>
        ...
        <p class="text-red-600 text-xl sm:text-2xl lg:text-3xl">{{$jumlah_customer}}</p>
