...
class CategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $categories = [
            ...
            "Brosur dan Flyer" => "Buat brosur dan flyer berkualitas tinggi untuk promosi produk atau layanan Anda.",
            "Poster" => "Cetak poster berbagai ukuran dengan warna tajam dan detail sempurna.",
            "Buku dan Majalah" => "Layanan percetakan untuk buku, majalah, atau jurnal dengan hasil cetak premium.",
            ...
            "Stiker dan Label" => "Percetakan stiker dan label custom untuk produk atau promosi.",
